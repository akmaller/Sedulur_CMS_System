    ...
    <>
      ...
      >
        <aside
          ref={asideRef}
          className={cn(
            "flex min-h-screen w-[18rem] max-w-[85vw] flex-col border-l border-border/60 bg-background/95 shadow-[0_20px_60px_rgba(10,10,16,0.45)] backdrop-blur-xl transition-transform duration-200 ease-out will-change-transform",
        ...
        >
          <div className="flex items-center justify-between border-b border-border/60 px-4 py-3">
            ...
            <button
              type="button"
              onClick={closeMenu}
              className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-border/70 text-muted-foreground transition hover:border-primary/60 hover:text-primary"
          ...
          <div className="border-b border-border/60 px-4 py-3">
            <div className="flex w-full flex-col gap-2">
              <Link
                href="/search"
                className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-border/60 bg-card/40 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-foreground transition hover:border-primary/60 hover:bg-primary/10 hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
                onClick={closeMenu}
              >
