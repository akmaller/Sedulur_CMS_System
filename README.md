# Sedulur Personal Blog CMS

Sedulur Personal Blog CMS adalah evolusi dari platform RoemahCita yang difokuskan untuk pemilik blog pribadi. Aplikasi ini tetap memanfaatkan Next.js App Router namun menghadirkan pengalaman lebih ringkas: cukup kelola artikel, halaman statis, media, dan hero slider publik lewat dashboard sederhana. Skema multi-penulis, komentar publik, album, dan menu builder telah dihilangkan sehingga penulis tunggal dapat fokus menulis tanpa distraksi.
...
```
app/
├── (public)/               # Halaman publik blog pribadi & layout publik
├── (dashboard)/            # Dashboard admin dan modul hero slider
├── api/                    # Endpoint internal (auth, media, dsb.)
├── globals.css             # Gaya global dan tema Tailwind
└── layout.tsx              # Root layout dan font
components/                 # Komponen UI reusable
config/                     # Konfigurasi navigasi dan situs
lib/                        # Helper (auth, prisma, utilitas)
